                ...
                if (userId) {
                    ...
                    try {
                        let params = {
                            userId,
                            subscription: 'shunt',
                            businessId: req.query.campId || '',
                            businessType: 'camp'
                        };
                        let result = await proxy.apiProxyPromise(conf.baseApi.university.shuntAppId, params, conf.baseApi.secret, req);
                        console.log(result, 'result', params);
                        let appId = lo.get(result, 'data.appId', '');
