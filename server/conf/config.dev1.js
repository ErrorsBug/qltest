var apiPrefix = {
    ...
    pointApi: 'http://inner.point.dev1.qlchat.com',
    speakApi: 'http://inner.speak.dev1.qlchat.com', //开发环境ip 统一使用这个别改
    commentApi: 'http://inner.comment.dev1.qlchat.com',
    interactApi: 'http://inner.interact.dev1.qlchat.com', 
    shortKnowledgeApi: 'http://inner.common.dev1.qlchat.com',
    toSourceApi: 'http://inner.dev1.qlchat.com',
    followApi: 'http://hfsqx.dev1.qlchat.com',
    homeworkApi: 'http://inner.homework.dev1.qlchat.com',
    ufwApi: 'http://ufw.dev1.qlchat.com'
};
...
var secretMap = {
    ...
    followApi: '846d2cb0c7f09c3ae802c42169a6302b',
    homeworkApi: '846d2cb0c7f09c3ae802c42169a6302b',
    ufwApi: '76f8fc992ba4166d5e9fee3a3f19af22'
};
...
var config = {
    ...
    'spaCollectjs': 'http://collect.dev1.qlchat.com/js/c.click.event.pv.error.visible.query.onlog.browse.commonlog.js?9',
