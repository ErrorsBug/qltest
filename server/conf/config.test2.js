var apiPrefix = {
    baseApi: 'http://inner.test2.qlchat.com',
    appApi: 'http://app.test2.qlchat.com',
    weiboApi: 'http://inner.test2.qlchat.com',
    wechatApi: 'http://inner.test2.qlchat.com',
    adminApi: 'http://inner.test2.qlchat.com',
    activityApi: 'http://inner.activity.test2.qlchat.com',
    weappApi: 'http://inner.opsweapp.qlchat.com',
    couponApi: 'http://inner.coupon.test2.qlchat.com',
    shareFrontApi: 'http://inner.share-front.test2.qlchat.com',
    communityApi: 'http://inner.community.test2.qlchat.com',
    choiceApi: 'http://livecenter.test2.qlchat.com',
    pointApi: 'http://inner.point.test2.qlchat.com',
    speakApi: 'http://inner.speak.test2.qlchat.com', //开发环境ip 统一使用这个别改
    commentApi: 'http://inner.comment.test2.qlchat.com',
    interactApi: 'http://inner.interact.test2.qlchat.com', 
    shortKnowledgeApi: 'http://inner.common.test2.qlchat.com',
    toSourceApi: 'http://inner.test2.qlchat.com',
    kaifangApi: 'http://inner.kaifang.test2.qlchat.com'
};
...
var config = {
    ...
    // 微信开放平台appid
    wxOpenAppId: 'wx4550a36be50fc857',

    // 微博开放平台应用id
    weiboClientId: '3939804953',

    // 日志采集sdk及api前缀配置
    'collectjs': 'http://collect.test2.qlchat.com/js/c.click.event.pv.error.visible.query.onlog.onpv.onvisible.browse.commonlog.js',
    'spaCollectjs': 'http://collect.test1.qlchat.com/js/c.click.event.pv.error.visible.query.onlog.js?9',
    'collectApiPrefix': 'http://collect.test2.qlchat.com',
    'websocketUrl': 'ws://h5ws.test2.qlchat.com',
};
