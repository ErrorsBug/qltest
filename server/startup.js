...
var fs = require('fs'),
    ...
    modes = {
        ...
        dev1: ['development1', 'dev1', 'DEV1'],
        dev2: ['development2', 'dev2', 'DEV2'],
        test1: ['test1', 'TEST1'],
        test2: ['test2', 'TEST2'],
        test3: ['test3', 'TEST3'],
        test4: ['test4', 'TEST4'],
...
if (require.main === module) {
    ...
    commander
        ...
        .option('-l, --localUserId <useryyyId>', 'useryyyId of local development')
        .parse(process.argv);
    ...
    if (conf.mode != 'prod') {
        ...
        babelRegister({
	        ...
	        //     return /node_modules\/(?!lodash-es)/.test(filename)
	        // },
	        extensions: [ '.js', '.jsx' ],
            // plugins: [
		     //    ["css-modules-transform", {
			 //        "preprocessCss": function processSass(data, filename) {
