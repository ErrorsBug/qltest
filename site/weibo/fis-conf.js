...
fis.match('websocket.js', {
    parser: websocketUrlReplace('ws://dev.ws.qlchat.com/websocket'),
});
...
fis.media('cdn_prod')
    ...
    .match('websocket.js', {
        parser: websocketUrlReplace('wss://ws-h5.qianliao.cn/websocket'),
    });
...
fis.hook('module', {
    ...
    paths: {
        ...
        hbardatetimeformat: '/components_modules/hbars-helper/1.0.0/date-format',
...
function websocketUrlReplace(wsUrl) {
    return function (content, file, options) {
         return content.replace('__wsUrl__', wsUrl);
    };
}
