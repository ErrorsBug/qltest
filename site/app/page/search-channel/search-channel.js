...
var search = {
    ...
    enableScrollLoad: function () {
        ...
        new scrollload.UpScrollLoad('#container', function (loadingCtx, finishFn, errorFn) {
            that.loadChannelList(finishFn, errorFn);
        }, {
                marginBottom: 1000,
            });
    },
    ...
    nomoreData: false,
    loadChannelList: function (finishFn, errorFn) {
        ...
        model.fetch({
            ...
            success: function (result) {
                ...
                if (result.state.code === 0) {
                    view.updateList(result.data.channels);
