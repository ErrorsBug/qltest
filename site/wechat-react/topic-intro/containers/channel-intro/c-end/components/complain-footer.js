...
export default class ComplainFooter extends React.Component{
    ...
    locationToCreateLive() {
		...
		const url = fillParams({resTime}, '/wechat/page/backstage')
                ...
                <div className="footer-container">
                    ...
                    }
                    {
                        ...
                        <div className="complain-footer">
                            ...
                            <i>千聊提供技术支持</i>
                            <a href={`/wechat/page/complain-reason?channelId=${this.props.channelId}&link=${encodeURIComponent(window.location.href)}`} className="qianliao-complain">
                                <span>投诉举报</span>
                            </a>
                        </div>:null
                    }
