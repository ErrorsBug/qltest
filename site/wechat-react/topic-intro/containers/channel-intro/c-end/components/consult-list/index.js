    ...
    return <section>
        ...
        <main className='consult-content'>
            <article>
                ...
                <p>{props.content}</p>
                <span
                    className={props.isLike === 'Y' ? 'like ed on-log' : 'like on-log'}
                    data-log-region="consult-like-btn"
...
class ConsultList extends PureComponent {
    render () {
        return (
            <div>
                <div className='channel-intro-consult-list'>
                    <div className="title">
                ...
                </div>
                {
                    ...
                    <div className="channel-intro-consult-list-check-more on-log"
                         data-log-region="channel-intro-consult-list-check-more"
                         onClick={this.props.onShowConsultPop}>查看更多留言</div>
                }
            </div>
        );
    }
