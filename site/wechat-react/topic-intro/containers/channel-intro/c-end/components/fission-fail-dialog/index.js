...
@autobind
class FissionFailDialog extends Component {
	constructor(props) {
		super(props)
		this.state = {
			saveSecond: 900,
	...
	hide(e) {
		...
		if (e === 'cancel') {
			if (this.props.unlockCourseInfo.failPayUrl && this.props.unlockCourseInfo.failPayUrl.indexOf('http') > -1) {
				locationTo(this.props.unlockCourseInfo.failPayUrl)
			} else {
...
export default FissionFailDialog
