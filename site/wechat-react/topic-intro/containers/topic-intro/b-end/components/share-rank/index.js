    ...
    render() {
        return (
            <section className='share-rank-container icon_enter'
                onClick={() => locationTo(`/wechat/page/distribution/promo-rank?businessId=${this.props.topicInfo.channelId ? this.props.topicInfo.channelId : this.props.topicId}&businessType=${this.props.topicInfo.channelId ? 'channel' : 'topic'}`)}
            >
