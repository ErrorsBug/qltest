...
class ComplainFooter extends Component {
    ...
    locationToCreateLive() {
		...
		const url = fillParams({resTime}, '/wechat/page/create-live?ch=create-live_admin_topic')
            ...
            <div className="footer-container">
                {
                    ...
                    <div className="creat-studio on-visible on-log" data-log-region="topicIntroCreatStudioBtn" onClick={this.locationToCreateLive.bind(this)}>我也要创建直播间</div>
                }
                {
