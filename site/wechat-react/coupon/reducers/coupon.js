import {
    ...
    INIT_CAMP_DISCOUNT_CODE_INFO,
    INIT_CAMP_DISCOUNT_CODE,
...
export function coupon(state = initState, action) {
    switch (action.type) {
        ...
        case INIT_CAMP_DISCOUNT_CODE_INFO:
            return {
                ...state,
                campDiscountCodeInfo: action.campDiscountCodeInfo
            };
        case INIT_CAMP_DISCOUNT_CODE:
            return {
                ...state,
                campDiscountCode: action.campDiscountCode
            };
