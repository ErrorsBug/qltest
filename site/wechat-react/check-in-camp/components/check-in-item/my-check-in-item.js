...
@autobind
export class MineCheckInItem extends Component {
    static propTypes = {
        // Long    打卡动态id
    ...
    render() {
        return (
            <div className="my-check-in-item-container">
...
export default connect(mapStateToProps, mapDispatchToProps)(MineCheckInItem)
