 ...
 * @returns
 */
export function getFollowQr({channelCode = 204 , channelId = '' , liveId , topicId = '', isBindThird , isFocusThree , subscribe , isShowQl = true , showLoading = false, toUserId ='' }) {
    return (dispatch, getStore) => {
        let showQl = 'N';
        let channel = '101'
        // 是否首页和推荐页进来
        ...
        let result = dispatch(getQr({ channel, channelId, liveId, topicId, showQl, showLoading ,toUserId }));
        return result;
    }
}
/**
