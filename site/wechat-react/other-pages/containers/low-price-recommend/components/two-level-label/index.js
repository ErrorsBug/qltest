        ...
        return (
            <article className={classnames("two-level-label", this.props.containerClass)}>
                <OneLevelLabel
                    ...
                    isPickedUp = {!this.props.displayFirstTag}
                    region={'menu'}
                />
                <OneLevelLabel
                    listInfo = {this.props.secondListInfo}
                    liClassName = {this.props.secondLiClassName}
                    sectionClassName = {this.props.secondSectionClassName}
                    ulClassName = {this.props.secondUlClassName}
                    labelClickFunc = {this.props.secondLabelClickFunc}
                    activeLabelSign = {this.props.nowSecondLabel}
                    isPickedUp = {!this.props.displaySecondTag}
                    region={'sub-menu'}
                />
            </article>
        );
