        ...
        return (
            <div className="return-list-wrap">
            {
                this.props.list.map((item, index) => {
                    return (
                        <div className='represent-list-item' key={`return_${index}`}>
                            <div className="return-flex" 
                                onClick={_ => locationTo(`/wechat/page/distribution-represent-detail-list/${this.props.topicId}?userId=${item.userId}&type=return&businessType=topic`)}>
