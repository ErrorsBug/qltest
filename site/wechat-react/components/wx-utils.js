...
import { getCookie, genUniqStr } from './util';
...
export function share(opts) {
    ...
    const userSourceId = userId.toString(16);
    ...
    function _initSahreConfig() {
        ...
        // wx.updateAppMessageShareData(shareAppOptons);
        // wx.updateTimelineShareData(shareAppOptons);
