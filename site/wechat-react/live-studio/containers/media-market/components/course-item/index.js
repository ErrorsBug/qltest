...
export default class CourseItem extends Component {
    static propTypes = {
        ...
        pauseListening: PropTypes.func, tweetId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
        // 三方推文链接
        tweetUrl: PropTypes.string,
        // 当前直播间 liveId
        liveId: PropTypes.string,
            ...
            <div className="course-item">
                ...
                />
                {
                    ...
                    <div className="operation-area">
                        ...
                        <div className={`operate-btn reprint-btn ${this.props.isRelay === 'Y' ? 'disabled' : ''}`} onClick={() => this.onReprintBtnClick(reprintChannelInfo)}>
                            {
                                this.props.isRelay !== 'Y' ? `赚￥${(this.props.reprintChannelDiscount * this.props.selfMediaPercent / 100).toFixed(2)}` : "去推广"
                            }    
                        </div>
                    </div> :
                    null
