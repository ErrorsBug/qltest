...
export default class extends Component {
    ...
    render() {
        ...
        const { id,createBy, createByName,createByHeadImgUrl,content,createTime, isMore,calDay,sysTime,isGuest,deleteComment,verify  } = this.props; 
        return (
            <Fragment> 
                    ...
                    <div className="comment-cont">
                        <div className="comment-h flex jc-between flex-vcenter">
                            ...
                            <div
                                ...
                                className={ `on-visible on-log like-status ${ likes ? 'linked' : '' }` }>{ likesNum || 0 } <i className={`iconfont ${likes ?"iconyidianzan":"iconweidianzan"}`}></i></div>
                        </div>
                        <div className="comment-datail">
                            <ToggleContent  
                                maxLine={5}  
                                children={
                                    <span className="comment-datail-desc"
                                    ...
                                    <div key={ index } 
                                        ...
                                        <div className="comment-h flex jc-between flex-vcenter">
                                            ...
                                            <div
                                                ...
                                                className={ `on-visible on-log like-status ${ item.likes ? 'linked' : '' }` }>{ item.likesNum || 0 } <i className={`iconfont ${item.likes ?"iconyidianzan":"iconweidianzan"}`}></i></div>
                                        </div>
                                        <div>
                                            <ToggleContent  
                                                maxLine={5}  
