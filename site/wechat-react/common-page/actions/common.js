 ...
 * @returns
 */
export function getQr({ channel, channelId, liveId, toUserId = '', topicId, showQl, showLoading = false, ...other}) {
    return (dispatch, getStore) => {
        return api({
            dispatch,
            getStore,
            ...
            body: {
                channel, channelId, liveId, toUserId, topicId, showQl, ...other
            }
        });
    }
}
...
// 获取邀请者的信息
export function getInviterInfo(userId, otherUserId) {
    var params = {
        userId,
        otherUserId
    };
