...
class ImgUpload extends Component {
    ...
    initStsInfo() {
        this.setState({
            notWx : this.props.notWx!==undefined? this.props.notWx :(Detect.os.weixin&&Detect.os.phone)
        })
    ...
    onSelectImage(e) {
        if (Detect.os.weixin&&Detect.os.phone&&this.state.notWx) {
            this.addImageWx();
        } else {
            this.addImagePc(e);
        }
     ...
     */
    addImageWx() {
        console.log(Object.prototype.toString.call(this.props.count), Object.prototype.toString.call(this.props.count)=="[object Number]")
        let count = (this.props.count <= 9 && this.props.count >= 0) ? this.props.count : 9;
