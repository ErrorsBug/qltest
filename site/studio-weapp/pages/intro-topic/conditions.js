...
const conditions = {
    ...
    initUsualConditions: function (data) {
        console.log('data.vipInfo.isVip', data.vipInfo.isVip);
        var conditions = {
            /* 话题相关*/
    ...
    initFooterConditions: function (data) {
        ...
        if (that._conditions.isChannel && data.channel) {
            ...
            conditions.channelCharge = '购买频道：￥' + charge;
            ...
            conditions.channelRealCharge = '购买频道：￥' + conditions.channelPayCharge / 100;
            /* 频道收费多种价格显示*/
    ...
    initPriceCondition: function (data) {
        ...
        conditions.coupon_access_link = that._conditions.sharekey
            ...
            : 'wechat/page/coupon-code/exchange/topict/' + data.topicView.topicPo.id;
