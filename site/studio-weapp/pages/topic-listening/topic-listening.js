...
Page({
    ...
    checkHistory() {
        ...
        /* 正在播放的话题都会打历史记录，因此拿最新一条记录与当前话题对比topicId就可以 */
    ...
    saveHistory() {
        ...
        const { data, currentTime } = this.player
    ...
    updateComment(data) {
        ...
        this.setData({ commentNoMore, commentNoneOne, commentList, commentPage })
    },
    /* 评论发送成功后在列表最前面插上这条数据 */
    prependComment(e) {
