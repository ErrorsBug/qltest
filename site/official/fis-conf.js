...
fis.media('cdn_dev')
    .match('*.{js,css,scss,jpg,png,jpeg,gif,ttf,eot,svg,woff}', {
    ...
    postpackager: fis.plugin('loader', {
        ...
        allInOne: {
            ...
            ignore: [
                ...
                '/components_modules/jquery/1.11.2/jquery-1.11.2.js',
            ],
        },
...
fis.hook('module', {
    ...
    paths: {
        ...
        jquery:'/components_modules/jquery/1.11.2/jquery-1.11.2.js',
    },
});
