...
class WechatInfo extends React.Component<props, any> {
    ...
    getSelectContainer() {
        return document.getElementById('wechat-info-form');
    }
            ...
            <section className={styles.wechatInfoContainer}>
                ...
                <div id="wechat-info-form">
                    ...
                    <FormItem label="公众号分类" {...formItemLayout}>
                        <Select placeholder="请选择公众号分类" value={category || undefined} data-field="category" onChange={this.handleCategorySelect} style={{ width: '100%' }} getPopupContainer={this.getSelectContainer}>
                        {
